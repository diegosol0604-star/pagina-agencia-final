...
**Flow Studio** — a Spanish-language marketing agency website (Mexico) built with Next.js 16 App Router + Tailwind CSS v4. Two public routes: `/` (home) and `/automatizaciones`.
